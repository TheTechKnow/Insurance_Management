...
INSERT INTO `tables_priv` VALUES ('localhost','mysql','mysql.session','user','boot@','2024-02-11 21:16:52','Select',''),('localhost','sys','mysql.sys','sys_config','root@localhost','2024-02-11 21:16:52','Select',''),('localhost','insurance_data','root','insurance_data','root@localhost','2024-05-04 04:39:26','Select,Insert,Update,Delete,Create,Drop,References,Index,Alter,Create View,Show view,Trigger','');
...
-- Dump completed on 2024-05-03 21:40:55
